...
# <-- CLASSIFIER DEEP --> #
DEFAULT_CLASSIFER_DEEP_IMAGE_SIZE = 256
DEFAULT_CLASSIFIER_DEEP_MATCHER_PATH = "./matchers/classifier-deep.hnsw"
DEFAULT_CLASSIFIER_DEEP_FORCE_MATCHER_COMPUTE = False
DEFAULT_CLASSIFIER_DEEP_K_NN = 1
...
DEFAULT_CLASSIFIER_DEEP_MODEL_PATH = "./models/triplet-vgg.hdf5"
DEFAULT_CLASSIFIER_DEEP_FORCE_TRAIN = False

# <-- DETECTOR --> #
DEFAULT_DETECTOR_CATALOG_IMAGE_WIDTHS = [1000, 900, 800, 700, 600, 500, 400, 300, 200, 100]
